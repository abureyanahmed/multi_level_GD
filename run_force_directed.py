...
#force_directed("Layer6.txt", "Layer6_force_directed.txt", "500", "no_repulsion_crossing", "input")
#force_directed("Layer7_component.txt", "Layer7_force_directed.txt", "500", "no_repulsion_crossing", "input")
